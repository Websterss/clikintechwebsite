        ...
        <div className="our-service-container">
            ...
            <div className="service-container text-center flex">
                <div className="row">
                    <div className="col">
                        <div className="card">
                            <img src={image1} alt="Digital Marketing Image" className="card-img" />
                            ...
                            <a href="#" className="btn">Explore more<BiChevronRight /></a>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card">
                            <img src={image2} alt="Web Development Image" className="card-img" />
                            <div className="card-body">
                    ...
                    <div className="col">
                        <div className="card">
                            <img src={image3} alt="Mobile Development Image" className="card-img" />
                            <div className="card-body">
